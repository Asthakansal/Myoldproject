...
public class ProductRestController {
	...
	@PostMapping("/user/{username}/product/{productName}/{cost}/{brandName}/{category}")
	public ResponseEntity<MyDTO> addProductByUser(@PathVariable String username,@PathVariable String productName,@PathVariable int cost,@PathVariable String brandName,@PathVariable  String category)
	{
		...
		try {
			...
			if(savedUser != null)
			{
				Product product = new Product(productName,cost,brandName,category,LocalDate.now().toString());
